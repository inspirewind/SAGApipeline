...
from snakemake_job_parser import get_braker2_finished_lis, log2dic
...
# TODO: make better
result_top = r'D:\new_ncbi_dataset\genomes_rec_part\done_ips_Rhodophyta_2763'
Ha_test_snakemake_log = r'2022-03-04T204258.689421.snakemake.log'
snakemake_join = r'.snakemake\log'
snakemake_path = os.path.join(result_top, snakemake_join, Ha_test_snakemake_log)
Ha_test_lis = get_braker2_finished_lis(snakemake_path)
# todo end
